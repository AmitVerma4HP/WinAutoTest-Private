...
public class ChromeAppBase extends Win32Base {
		...
		public void PrintChromeFile(String ptr_name, String orientation, String duplex_optn, String color_optn, String prnt_quality, String paper_size, String device_name) throws InterruptedException, MalformedURLException {
			
			//Launching the Classic print window as the UWP print window not recognised by Winappdriver.
			Thread.sleep(1000);ChromeSession.getKeyboard().sendKeys(Keys.CONTROL, Keys.SHIFT);
		...
		public static void SwitchToChromeSession(String device_name) throws MalformedURLException {
			...
			log.info("Chrome session created successfully");
