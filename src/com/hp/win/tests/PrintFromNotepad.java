...
public class PrintFromNotepad extends NotepadBase{
	...
	@Test
	@Parameters({ "ptr_name", "copies","collate", "orientation", "duplex_optn", "color_optn", "prnt_quality", "paper_size", "device_name" })
    public void PrintNoteFile(String ptr_name, @Optional("1")String copies, @Optional("Collate")String collate, @Optional("Portrait")String orientation, @Optional("None")String duplex_optn, @Optional("Color")String color_optn, @Optional("Draft")String prnt_quality, @Optional("Letter")String paper_size, String device_name) throws InterruptedException, IOException
    {   
		// Method to Print Notepad File to Printer Under Test
		PrintNotePadFile(ptr_name, copies, collate, orientation, duplex_optn, color_optn, prnt_quality, paper_size, device_name);
	}
